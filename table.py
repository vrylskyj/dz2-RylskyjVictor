...
# Рівень 2: Шифр Віженера і табличний шифр
...
def double_decrypt(text, key1, key2):
    table_decrypted = table_cipher_decrypt(text, key2)
    vigenere_decrypted = vigenere_decrypt(table_decrypted, key1)
...
# Рівень 1
encrypted_text = table_cipher_encrypt(text, key1)
print("Табличний шифротекст:", encrypted_text)
decrypted_text = table_cipher_decrypt(encrypted_text, key1)
print("Табличний розшифрований текст:", decrypted_text)

# Рівень 2
double_encrypted_text = double_encrypt(text, key1, key2)
print("Подвоєний шифротекст:", double_encrypted_text)
double_decrypted_text = double_decrypt(double_encrypted_text, key1, key2)
print("Подвоєний розшифрований текст:", double_decrypted_text)
